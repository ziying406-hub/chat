      ...
      <div className="bg-white mt-2 border-y border-gray-50">
        <div className="px-5 py-3.5 flex items-center justify-between border-b border-gray-50">
          ...
          <button
            ...
            className={`w-11 h-6 rounded-full transition-colors ${notif ? "bg-primary-500" : "bg-gray-200"}`}
          >
        ...
        <div className="px-5 py-3.5 flex items-center justify-between border-b border-gray-50">
          ...
          <button
            onClick={toggleDark}
            className={`w-11 h-6 rounded-full transition-colors ${darkMode ? "bg-primary-500" : "bg-gray-200"}`}
          >
      ...
      <div className="bg-white mt-2 border-y border-gray-50 px-5 py-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-xs ${fontScale === 0.85 ? "bg-primary-50 text-primary-500" : "bg-gray-50 text-gray-400"}`}
          >小</button>
          <button
            onClick={() => setFontScale(1)}
            className={`flex-1 py-2 rounded-lg text-xs ${fontScale === 1 ? "bg-primary-50 text-primary-500" : "bg-gray-50 text-gray-400"}`}
          >标准</button>
          <button
            onClick={() => setFontScale(1.15)}
            className={`flex-1 py-2 rounded-lg text-xs ${fontScale === 1.15 ? "bg-primary-50 text-primary-500" : "bg-gray-50 text-gray-400"}`}
          >大</button>
        </div>
      </div>
    </div>
